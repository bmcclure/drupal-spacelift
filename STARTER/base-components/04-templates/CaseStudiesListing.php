...
include "components/03-organisms/LargeLatestCaseStudy/LargeLatestCaseStudy.php";
include "components/03-organisms/CaseStudiesListingResults/CaseStudiesListingResults.php";
