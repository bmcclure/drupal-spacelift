...
<div class="OffcanvasMenu">
  ...
  if ($main_nav) {
    ?>
    <ul id="OffcanvasMenu-menu"
        class="OffcanvasMenu-menu vertical menu drilldown" data-drilldown>
      <?php
      $i = 0;
      foreach ($main_nav as $toplevel) {
        ...
        ?>
        <li id="OffcanvasMenu-<?php echo $i; ?>"
            class="<?php echo $special_classes; ?> <?php echo $classes; ?> OffcanvasMenu-menuParent">
          <a href="<?php echo $toplevelUrl; ?>"><?php echo $toplevelName; ?></a>
          <?php if ($children) { ?>
            <ul
              class="OffcanvasMenu-menuChildren vertical menu nested accordion-menu "
              data-accordion-menu
              ...
              foreach ($children as $child) {
                ...
                ?>
                <li id="OffcanvasMenu-child-<?php echo $b; ?>"
                    class="OffcanvasMenu-menuChild <?php echo $extraclasses;
                    if ($childDescription) {
                  ...
                  if (strpos($child_special_classes, 'MegaMenu-teasers') !== FALSE) {
                    ...
                    if ($grandchildren) {
                      if ($thirdlevelmenu === TRUE) {
                        ?>
                        <ul
                          class="OffcanvasMenu-grandchildren menu vertical nested">
                          <?php
                          foreach ($grandchildren as $grandchild) {
                            $grandchildName = $grandchild['name'];
                            $grandchildUrl = $grandchild['url'];
                            ...
                            <li class="OffcanvasMenu-grandchild">
                              <a
                                href="<?php echo $grandchildUrl; ?>"><?php echo $grandchildName; ?></a>
                              <?php
                        ...
                        ?>
                        <div
                          class="OffcanvasMenu-grandchildren OffcanvasMenu-grandchildren--noMenu">
                          <?php
                          foreach ($grandchildren as $grandchild) {
                            $grandchildName = $grandchild['name'];
                            $grandchildUrl = $grandchild['url'];
      ...
      if ($utility_menu) {
        foreach ($utility_menu as $menu_item) {
          ...
          if ($children) { ?>
            <ul
              class="OffcanvasMenu-menuChildren vertical menu nested accordion-menu OffcanvasMenu--utility"
              data-accordion-menu
              data-submenu-toggle="true">
              ...
              <li class="OffcanvasMenu-menuChild OffcanvasMenu--utilityChild"><a
                  href="<?php echo $childUrl; ?>"><?php echo $childName; ?></a>
              <?php } ?>
            </ul>
            <?php
          }
      ...
      <li class="OffcanvasMain-buttons">
        <a href="#" class="button OffcanvasMain-button"><span
            class="fas fa-envelope"></span> CONTACT SUPPORT
          <span
