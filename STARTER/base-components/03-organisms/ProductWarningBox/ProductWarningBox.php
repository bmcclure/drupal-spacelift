...
/**
 * @file
 * Warning LightBox and Warning Callout.
 *
 * Used on Product Detail page for custom products.
 */
?>
<div class="ProductWarningBox text-center"><i
    class="fas fa-exclamation-triangle"></i> <b>WARNING:</b> Your selections
