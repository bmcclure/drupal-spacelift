...
<div id="ProductPresetOptions" class="ProductPresetOptions">
  ...
  <div class="flex-container align-middle">
    ...
    <div class="flex-child-auto">
            <span class=" Tooltip" data-tooltip tabindex="2" data-position="top"
  ...
  <select name="pipe-diameter" id="pipe-diameter" v-model="size"
          @change="onSizeChange(mounting)">
  ...
  <div class="field">
    ...
    <?php foreach ($sizes as $size) {
      ...
      <div v-if="size === '<?php echo $sizeValue ?>'">
        <!-- only display if this size option selected -->
  ...
  <div class="ProductCustomVariableOptions-uvlaminate title ">
    <ul class="Checkboxes">
      <li class="Checkbox facet-item">
        <input type="checkbox" class="Checkbox-input" id="uv2">
        <!-- @todo currently this is a unique id, but technically it needs to function the same as the id=uv on custom tab-->
        <label for="uv2">
