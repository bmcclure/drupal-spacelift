...
/**
 * Main Nav
 * Notes: The ul, li structure seems pretty standard. Hopefully this matches up with Drupal
 */
                                ...
                                <div class="grid-container">
                                    <div class="MegaMenu-footerRow">
                                        <div class="MegaMenu-footerItem">
                                            <a href="#"><span class="fas fa-search-location"></span> Find a Rep <span
                                                        class="fas fa-caret-right"></span></a>
                                        </div>
                                        <div class="MegaMenu-footerItem">
                                            <a href="#"> <span class="fas fa-envelope"></span> Contact Support <span
                                                        class="fas fa-caret-right"></span></a>
                                        </div>
                                        <div class="MegaMenu-footerItem">
                                            <a href="tel:+18002340135"><span class="fas fa-phone"></span> TALK TO A CSR
