...
<div class="OffcanvasMyAccount Header-offcanvas off-canvas position-left" id="OffcanvasMyAccount"
     data-off-canvas
    ...
    <div class="OffcanvasMain-container">
        ...
        <div class="OffcanvasMenu">
			<?php
			if ( $right_menu ) { ?>
                <ul id="OffcanvasMenu-menu2" class="OffcanvasMenu-menu menu vertical accordion-menu" data-accordion-menu
