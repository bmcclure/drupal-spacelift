    ...
    var app = new Vue({
        ...
        data: {
            ...
            sizeOptions: [
                ...
                {title: '1.5" Round', value: 'round-1-5', mounting: [0, 1], lines: 1, characterLimit: 12, presets: []},
                {title: '1.5" Square', value: 'square-1-5', mounting: [0], lines: 2, characterLimit: 12, presets: []},
            ],
            mountingOptions: [
