            ...
            <div class="field">
                ...
                <div class="field">
                    <ul class="ColorCombinations RadioButtons FlexRow small-up-3 medium-up-6 large-up-4">
						<?php
						// FYI - here we are using the ColorCombinations styling, however we need the v-model for vue
						foreach ( $BackgroundColors as $background_color ) {
                            ...
                            <li class="RadioButtons-combo FlexRow-item">
                                <input
                                        ...
                                        name="color"
                                        value="<?= $name ?>"
                                        id="color<?= $capitalName ?>"
                                        class="ColorCombinations-input RadioButtons-input"
                                        data-color="<?= $name ?>"
                                        v-model="color"
                                >
                                <label for="color<?= $capitalName ?>"
                                       class="ColorCombinations-button RadioButtons-button button"
                                       style="background-color:<?= $hex_code ?>; color: <?= $text_color ?>; border: 1px solid <?= $border_color ?>;">
									<?= $capitalName ?>
                                </label>
                            </li>
							<?php
                    ...
                    <ul class="ColorCombinations RadioButtons FlexRow small-up-3 medium-up-6 large-up-4">
						...
						foreach ( $BackgroundColors as $text_color ) {
							...
							if ( $name2 === 'glow' ) {
								...
								if ( $name2 === 'yellow' ) {
									$hex_code2 = '#beb61e'; // per functional spec, yellow needs to be darker
								}
								?>
                                <li class="RadioButtons-combo FlexRow-item">
                                    <input
                                            ...
                                            name="textColor"
                                            value="<?= $name2 ?>"
                                            id="textColor<?= $capitalName2 ?>"
                                            class="ColorCombinations-input RadioButtons-input"
                                            data-color="text-<?= $name2 ?>"
                                            v-model="textColor"
                                    >
                                    <label for="textColor<?= $capitalName2 ?>"
                                           class="ColorCombinations-button RadioButtons-button button"
                                           style="background-color: <?= $background2 ?>; color: <?= $hex_code2 ?>; border:1px solid black;">
										<?= $capitalName2 ?>
                                    </label>
                                </li>
								<?php
